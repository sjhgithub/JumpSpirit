...
public class WebDavStore extends Store {
    ...
    throws MessagingException {
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Error during authentication: " + ioe + "\nStack: " + processException(ioe));
    ...
    public WebDavHttpClient getHttpClient() throws MessagingException {
        if (mHttpClient == null) {
            ...
            try {
                ...
                Log.e(MailChat.LOG_TAG, "NoSuchAlgorithmException in getHttpClient: " + nsa);
                throw new MessagingException("NoSuchAlgorithmException in getHttpClient: " + nsa);
            } catch (KeyManagementException kme) {
                Log.e(MailChat.LOG_TAG, "KeyManagementException in getHttpClient: " + kme);
        ...
        try {
            ...
            if (istream != null &&
                ...
                try {
                    ...
                    Log.e(MailChat.LOG_TAG, "SAXException in processRequest() " + se + "\nTrace: " + processException(se));
    ...
    class WebDavFolder extends Folder {
        ...
        public WebDavFolder(WebDavStore nStore, String name) {
            ...
            try {
                ...
                Log.e(MailChat.LOG_TAG, "UnsupportedEncodingException URLEncoding folder name, skipping encoded");
                encodedName = name;
            }
        ...
        throws MessagingException {
            ...
            Log.i(MailChat.LOG_TAG, "Moving " + messages.length + " messages to " + destFolder.mFolderUrl);
        ...
        private int getMessageCount(boolean read) throws MessagingException {
            ...
            if (MailChat.DEBUG && MailChat.DEBUG_PROTOCOL_WEBDAV) {
                Log.v(MailChat.LOG_TAG, "Counted messages and webdav returned: "+messageCount);
            }
        ...
        throws MessagingException {
            ...
            for (int i = 0, count = messages.length; i < count; i++) {
                ...
                if (wdMessage.getUrl().equals("")) {
                    ...
                    Log.i(MailChat.LOG_TAG, "Fetching messages with UID = '" + wdMessage.getUid() + "', URL = '"
                          + wdMessage.getUrl() + "'");
                    if (wdMessage.getUrl().equals("")) {
                ...
                try {
                    Log.i(MailChat.LOG_TAG, "Fetching message with UID = '" + wdMessage.getUid() + "', URL = '"
                          + wdMessage.getUrl() + "'");
                    ...
                    Log.e(MailChat.LOG_TAG, "IllegalArgumentException caught " + iae + "\nTrace: " + processException(iae));
                    throw new MessagingException("IllegalArgumentException caught", iae);
                } catch (URISyntaxException use) {
                    Log.e(MailChat.LOG_TAG, "URISyntaxException caught " + use + "\nTrace: " + processException(use));
                    throw new MessagingException("URISyntaxException caught", use);
                } catch (IOException ioe) {
                    Log.e(MailChat.LOG_TAG, "Non-success response code loading message, response code was " + statusCode
        ...
        private void fetchFlags(Message[] startMessages, MessageRetrievalListener listener) throws MessagingException {
            ...
            for (int i = 0, count = messages.length; i < count; i++) {
                ...
                try {
                    ...
                    Log.v(MailChat.LOG_TAG,"Under some weird circumstances, setting the read status when syncing from webdav threw an NPE. Skipping.");
                }
        ...
        throws MessagingException {
            ...
            for (int i = messages.length - 1; i >= 0; i--) {
                ...
                if (envelope != null) {
                    ...
                    Log.e(MailChat.LOG_TAG,"Asked to get metadata for a non-existent message: "+wdMessage.getUid());
                }
        ...
        public Message[] appendWebDavMessages(Message[] messages) throws MessagingException {
            ...
            for (Message message : messages) {
                ...
                try {
                    ...
                    Log.i(MailChat.LOG_TAG, "Uploading message as " + messageURL);
    ...
    class WebDavMessage extends MimeMessage {
        ...
        public void setUrl(String url) {
            ...
            try {
                ...
                Log.e(MailChat.LOG_TAG, "UnsupportedEncodingException caught in setUrl: " + uee + "\nTrace: "
                      + processException(uee));
            } catch (IllegalArgumentException iae) {
                Log.e(MailChat.LOG_TAG, "IllegalArgumentException caught in setUrl: " + iae + "\nTrace: "
        ...
        public void delete(String trashFolderName) throws MessagingException {
            ...
            Log.i(MailChat.LOG_TAG, "Deleting message by moving to " + trashFolderName);
                    ...
                    for (Map.Entry<String, String> entry : data.entrySet()) {
                        ...
                        if (header.equals("read")) {
                            ...
                            try {
                                ...
                                Log.e(MailChat.LOG_TAG, "Error parsing date: " + pe + "\nTrace: " + processException(pe));
                            }
    ...
    public class HttpGeneric extends HttpEntityEnclosingRequestBase {
        ...
        public HttpGeneric(final String uri) {
            ...
            if (MailChat.DEBUG) {
                Log.v(MailChat.LOG_TAG, "Starting uri = '" + uri + "'");
            }
            ...
            try {
                ...
                Log.e(MailChat.LOG_TAG, "UnsupportedEncodingException caught in HttpGeneric(String uri): " + uee
                      + "\nTrace: " + processException(uee));
            } catch (IllegalArgumentException iae) {
                Log.e(MailChat.LOG_TAG, "IllegalArgumentException caught in HttpGeneric(String uri): " + iae + "\nTrace: "
                      + processException(iae));
            }
            ...
            if (MailChat.DEBUG && MailChat.DEBUG_PROTOCOL_WEBDAV) {
                Log.v(MailChat.LOG_TAG, "url = '" + url + "' length = " + url.length()
                      + ", end = '" + end + "' length = " + end.length());
            }
            url = url + "/" + end;

            Log.i(MailChat.LOG_TAG, "url = " + url);
    ...
    public static class WebDavHttpClient extends DefaultHttpClient {
        ...
        public static void modifyRequestToAcceptGzipResponse(HttpRequest request) {
            Log.i(MailChat.LOG_TAG, "Requesting gzipped data");
        ...
        throws IOException {
            ...
            if (contentEncoding.contains("gzip")) {
                Log.i(MailChat.LOG_TAG, "Response is gzipped");
