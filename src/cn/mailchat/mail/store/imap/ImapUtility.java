...
package cn.mailchat.mail.store.imap;
...
public class ImapUtility {
            ...
            if (range != null) {
                ...
                if (colonPos > 0) {
                    ...
                    if (is32bitValue(first) && is32bitValue(second)) {
                        ...
                        Log.d(MailChat.LOG_TAG, "Invalid range: " + range);
                    }
                }
            }
        } catch (NumberFormatException e) {
            Log.d(MailChat.LOG_TAG, "Invalid range value: " + range, e);
        }
    ...
    private static boolean isNumberValid(String number) {
        ...
        Log.d(MailChat.LOG_TAG, "Invalid UID value: " + number);
