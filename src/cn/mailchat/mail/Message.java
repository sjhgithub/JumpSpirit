...
import cn.mailchat.mail.filter.CountingOutputStream;
...
public abstract class Message implements Part, CompositeBody {
    ...
    public String getMailId() {
        if (mMailId != null && mMailId.length() > 0)  {
            return mMailId;
        } else {
            return null;
        }
    ...
    public long calculateSize() {
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Failed to calculate a message size", e);
     ...
     * {@link cn.mailchat.activity.MessageView.Listener#loadMessageForViewHeadersAvailable(cn.mailchat.Account, String, String, Message)}
