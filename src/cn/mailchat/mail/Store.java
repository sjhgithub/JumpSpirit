...
public abstract class Store {
    ...
    protected static final int SOCKET_READ_TIMEOUT = 20000;
    protected static final int SOCKET_NOOP_TIMEOUT = 10000;
    ...
    public static void removeAccount(Account account) {
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Failed to reset remote store for account " + account.getUuid(), e);
        }

        try {
            removeLocalInstance(account);
        } catch (Exception e) {
            Log.e(MailChat.LOG_TAG, "Failed to reset local store for account " + account.getUuid(), e);
        }
    }
