...
public class TrustedSocketFactory {
    ...
    static {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Error getting information about available SSL/TLS ciphers and " +
                    "protocols", e);
        }
    ...
    public static Socket createSocket(Socket socket, String host, int port, String clientCertificateAlias)
        ...
        if (clientCertificateAlias != null && !clientCertificateAlias.isEmpty()) {
            keyManagers = new KeyManager[] { new KeyChainKeyManager(MailChat.app, clientCertificateAlias) };
        }

        SSLContext context = SSLContext.getInstance("TLS");
        context.init(keyManagers, trustManagers, null);
        
        // 根据K9更新移除可能导致问题的SSL/TLS会话缓存
        // Modified by LL
