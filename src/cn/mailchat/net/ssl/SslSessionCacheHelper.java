...
public class SslSessionCacheHelper {
    ...
    static {
        ...
        final File cacheDirectory = MailChat.app.getDir("sslcache", Context.MODE_PRIVATE);
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Failed to initialize SslSessionCacheHelper: " + e);
            sIsDisabled = true;
        }
    }
    ...
    public static void setPersistentCache(SSLContext sslContext) {
        ...
        try {
            ...
            // Something went wrong. Proceed without a session cache.
            Log.e(MailChat.LOG_TAG, "Failed to initialize persistent SSL cache: " + e);
            sIsDisabled = true;
        }
    }
}
