...
public class KeyChainKeyManager extends X509ExtendedKeyManager {
    ...
    private String chooseAlias(String[] keyTypes, Principal[] issuers) {
        ...
        for (String keyAlgorithm : keyTypes) {
            ...
            Log.w(MailChat.LOG_TAG, "Client certificate " + mAlias + " not issued by any of the requested issuers");
            return null;
        }
        Log.w(MailChat.LOG_TAG, "Client certificate " + mAlias + " does not match any of the requested key types");
        return null;
    }
}
