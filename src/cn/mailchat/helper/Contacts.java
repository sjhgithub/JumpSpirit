...
public class Contacts {
     ...
     * {@link cn.mailchat.EmailAddressAdapter} or more specificly by
    ...
    public ContactItem extractInfoFromContactPickerIntent(final Intent intent) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Failed to get email data", e);
        } finally {
    ...
    public Uri getPhotoUri(String address) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Couldn't fetch photo for contact with email " + address, e);
            return null;
        }
    }
