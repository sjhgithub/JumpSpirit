...
public class DatabaseUpgradeService extends Service {
    ...
    private static final String ACTION_START_SERVICE =
            "cn.mailchat.service.DatabaseUpgradeService.startService";
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (success) {
            ...
            if (MailChat.DEBUG) {
                Log.i(MailChat.LOG_TAG, "DatabaseUpgradeService started");
            }
    ...
    private void stopService() {
        ...
        if (MailChat.DEBUG) {
            Log.i(MailChat.LOG_TAG, "DatabaseUpgradeService stopped");
        }
    ...
    private void upgradeDatabases() {
        ...
        for (Account account : accounts) {
            ...
            try {
                ...
                Log.e(MailChat.LOG_TAG, "Database unavailable");
            } catch (Exception e) {
                Log.e(MailChat.LOG_TAG, "Error while upgrading database", e);
            }

            mProgress++;
        }

        MailChat.setDatabasesUpToDate(true);
