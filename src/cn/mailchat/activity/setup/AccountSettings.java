...
public class AccountSettings extends MailChatPreferenceActivity {
...
//        System.out.println("accountUuid:"+accountUuid);
        ...
        mLocalStorageProvider = (ListPreference) findPreference(PREFERENCE_LOCAL_STORAGE_PROVIDER);
        {
            ...
            providers = StorageManager.getInstance(MailChat.app).getAvailableProviders();
            int i = 0;
    ...
    private class PopulateFolderPrefsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            allFolderValues[0] = MailChat.FOLDER_NONE;
            allFolderLabels[0] = MailChat.FOLDER_NONE;
