...
public class FolderSettings extends MailChatPreferenceActivity {

    private static final String EXTRA_FOLDER_NAME = "cn.mailchat.folderName";
    private static final String EXTRA_ACCOUNT = "cn.mailchat.account";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Unable to edit folder " + folderName + " preferences", me);
            return;
        }
    ...
    public void onPause() {
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Saving folder settings failed", e);
        }
