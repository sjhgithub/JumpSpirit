...
import cn.mailchat.service.DatabaseUpgradeService;
 ...
 *     method.</li>
 * <li>{@link #actionUpgradeDatabases(Context, Intent)} will call {@link MailChat#areDatabasesUpToDate()}
 *     to check if we already know whether the databases have been upgraded.</li>
 * <li>{@link MailChat#areDatabasesUpToDate()} will compare the last known database version stored in a
 *     {@link SharedPreferences} file to {@link cn.mailchat.mail.store.LocalStore#DB_VERSION}. This
 ...
 * </p>
 */
public class UpgradeDatabases extends MailChatActivity {
    ...
    public static boolean actionUpgradeDatabases(Context context, Intent startIntent) {
        if (MailChat.areDatabasesUpToDate()) {
            return false;
        }
