...
public class ChooseIdentity extends MailChatListActivity {
    Account mAccount;
    ArrayAdapter<String> adapter;

    public static final String EXTRA_ACCOUNT = "cn.mailchat.ChooseIdentity_account";
    public static final String EXTRA_IDENTITY = "cn.mailchat.ChooseIdentity_identity";
