...
public class MailChatPreferenceActivity extends PreferenceActivity {
    @Override
    public void onCreate(Bundle icicle) {
        MailChatActivityCommon.setLanguage(this, MailChat.getK9Language());
        setTheme(MailChat.getK9ThemeResourceId());
