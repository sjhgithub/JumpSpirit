...
import cn.mailchat.crypto.CryptoHelper;
import cn.mailchat.crypto.OpenPgpApiHelper;
...
public class MessageOpenPgpView extends LinearLayout {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e(MailChat.LOG_TAG, "Unable to decrypt email.", me);
                }
    ...
    private void decryptVerify(Intent intent) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "UnsupportedEncodingException.", e);
        }
    ...
    private void getMissingKey() {
        try {
            ...
            Log.e(MailChat.LOG_TAG, "SendIntentException", e);
        }
    }
            ...
            switch (result.getIntExtra(OpenPgpApi.RESULT_CODE, OpenPgpApi.RESULT_CODE_ERROR)) {
                case OpenPgpApi.RESULT_CODE_SUCCESS: {
                    try {
                        ...
                        if (MailChat.DEBUG)
                            Log.d(MailChat.LOG_TAG, "result: " + os.toByteArray().length
                                    + " str=" + output);
    ...
    public boolean handleOnActivityResult(int requestCode, int resultCode, Intent data) {
        if (MailChat.DEBUG)
            Log.d(MailChat.LOG_TAG, "onActivityResult resultCode: " + resultCode);
    ...
    private void handleError(final OpenPgpError error) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "OpenPGP Error ID:" + error.getErrorId());
                    Log.d(MailChat.LOG_TAG, "OpenPGP Error Message:" + error.getMessage());
                }
