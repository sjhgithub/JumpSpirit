...
public class ProgressView extends RelativeLayout {
	...
	private void init(AttributeSet attrs) {
		...
		loadingStateProgressBarWidth = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressLoadingStateProgressBarWidth,
				208);

		loadingStateProgressBarHeight = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressLoadingStateProgressBarHeight,
				208);

		loadingStateBackgroundColor = typedArray.getColor(
				R.styleable.ProgressView_progressLoadingStateBackgroundColor,
				Color.TRANSPARENT);

		// Empty state attrs
		emptyStateImageWidth = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressEmptyStateImageWidth, 308);

		emptyStateImageHeight = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressEmptyStateImageHeight, 308);

		emptyStateTitleTextSize = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressEmptyStateTitleTextSize, 15);

		emptyStateContentTextSize = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressEmptyStateContentTextSize, 14);

		emptyStateTitleTextColor = typedArray.getColor(
				R.styleable.ProgressView_progressEmptyStateTitleTextColor,
				Color.GRAY);

		emptyStateContentTextColor = typedArray.getColor(
				R.styleable.ProgressView_progressEmptyStateContentTextColor,
				Color.GRAY);

		emptyStateBackgroundColor = typedArray.getColor(
				R.styleable.ProgressView_progressEmptyStateBackgroundColor,
				Color.TRANSPARENT);

		// Error state attrs
		errorStateImageWidth = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressErrorStateImageWidth, 308);

		errorStateImageHeight = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressErrorStateImageHeight, 308);

		errorStateTitleTextSize = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressErrorStateTitleTextSize, 15);

		errorStateContentTextSize = typedArray.getDimensionPixelSize(
				R.styleable.ProgressView_progressErrorStateContentTextSize, 14);

		errorStateTitleTextColor = typedArray.getColor(
				R.styleable.ProgressView_progressErrorStateTitleTextColor,
				Color.GRAY);

		errorStateContentTextColor = typedArray.getColor(
				R.styleable.ProgressView_progressErrorStateContentTextColor,
				Color.GRAY);

		errorStateButtonTextColor = typedArray.getColor(
				R.styleable.ProgressView_progressErrorStateButtonTextColor,
				Color.BLACK);

		errorStateBackgroundColor = typedArray.getColor(
				R.styleable.ProgressView_progressErrorStateBackgroundColor,
				Color.TRANSPARENT);
	...
	public void showEmpty(Drawable emptyImageDrawable, String emptyTextTitle,
		...
		switchState(State.EMPTY, emptyImageDrawable, emptyTextTitle,
	...
	public void showError(Drawable errorImageDrawable, String errorTextTitle,
		...
		switchState(State.ERROR, errorImageDrawable, errorTextTitle,
	...
	public void showError(Drawable errorImageDrawable, String errorTextTitle,
			String errorTextContent, String errorButtonText,
			View.OnClickListener onClickListener, List<Integer> skipIds) {
		switchState(State.ERROR, errorImageDrawable, errorTextTitle,
	...
	private void setLoadingView() {
		...
		loadingStateRelativeLayout = (RelativeLayout) view
				.findViewById(R.id.loadingStateRelativeLayout);
		loadingStateRelativeLayout.setTag(TAG_LOADING);

		loadingStateProgressBar = (ProgressBar) view
				.findViewById(R.id.loadingStateProgressBar);
