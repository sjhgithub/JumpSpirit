...
public class ActionBarDrawerToggle extends
	...
	public ActionBarDrawerToggle(Activity activity, ActionBar actionBar,
	...
	public ActionBarDrawerToggle(Activity activity, ActionBar actionBar,
			DrawerLayout drawerLayout, DrawerArrowDrawable drawerImage,
			int openDrawerContentDescRes, int closeDrawerContentDescRes) {
			...
			try {
				Method setHomeAsUpIndicator = ActionBar.class
						.getDeclaredMethod("setHomeAsUpIndicator",
								Drawable.class);
				setHomeAsUpIndicator.invoke(mActionBar, mDrawerImage);
				return;
			} catch (Exception e) {
