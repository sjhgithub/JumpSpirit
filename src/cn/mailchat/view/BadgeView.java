...
public class BadgeView extends TextView {
	...
	public static final int POSITION_VERTICAL_LEFT = 6;
	public static final int POSITION_VERTICAL_RIGHT = 7;
	...
	private void applyLayoutParams() {
		...
		case POSITION_CENTER:
			...
			break;
		case POSITION_VERTICAL_LEFT:
			lp.gravity = Gravity.LEFT | Gravity.CENTER_VERTICAL;
			lp.setMargins(0, 0, 0, 0);
			break;
		case POSITION_VERTICAL_RIGHT:
