...
public class MailChatPullToRefreshListView extends PullToRefreshListView {

    public MailChatPullToRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    // Add PullToRefreshListener to monitor four stages 
    // of PullToRefresh component
    // Modified by LL
    // BEGIN
	...
	protected void onPullToRefresh() {
		if (mListener != null) {
			mListener.onPullToRefresh(getCurrentMode());
		}
	...
	protected void onReleaseToRefresh() {
		if (mListener != null) {
			mListener.onReleaseToRefresh(getCurrentMode());
		}
	...
	protected void onRefreshing(boolean doScroll) {
		if (mListener != null) {
			mListener.onRefreshing(getCurrentMode());
		}
	...
	protected void onReset() {
		if (mListener != null) {
			mListener.onReset(getCurrentMode());
		}
		super.onReset();
	}
