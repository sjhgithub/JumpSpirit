...
public class ClientCertificateSpinner extends LinearLayout {
    ...
    public ClientCertificateSpinner(Context context, AttributeSet attrs) {
        ...
        if (context instanceof Activity) {
            ...
            Log.e(MailChat.LOG_TAG, "ClientCertificateSpinner init failed! Please inflate with Activity!");
        }
    ...
    public void chooseCertificate() {
        ...
        KeyChain.choosePrivateKeyAlias(mActivity, new KeyChainAliasCallback() {
            ...
            public void alias(String alias) {
                if (MailChat.DEBUG)
                    Log.d(MailChat.LOG_TAG, "User has selected client certificate alias: " + alias);
