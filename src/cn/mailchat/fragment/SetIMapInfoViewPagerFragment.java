...
import cn.mailchat.adapter.SetImapInfoTabPagerAdapter;
import cn.mailchat.view.pager.PagerSlidingTabStrip;

public class SetIMapInfoViewPagerFragment extends Fragment implements
        OnPageChangeListener {

	private PagerSlidingTabStrip mTabStrip;
	private ViewPager mViewPager;
	private SetImapInfoTabPagerAdapter mTabAdapter;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		if (mTabAdapter == null) {
			mTabAdapter = new SetImapInfoTabPagerAdapter(getChildFragmentManager(),
