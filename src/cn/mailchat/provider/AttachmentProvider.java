...
public class AttachmentProvider extends ContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://cn.mailchat.attachmentprovider");
    ...
    public static void clear(Context context) {
        ...
        for (File file : files) {
            try {
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "Deleting file " + file.getCanonicalPath());
                }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try {
            ...
            attachmentInfo = LocalStore.getLocalInstance(account, MailChat.app).getAttachmentInfo(id);
        } catch (MessagingException e) {
            Log.e(MailChat.LOG_TAG, "Unable to retrieve attachment info from local store for ID: " + id, e);
            return null;
        }

        if (attachmentInfo == null) {
            if (MailChat.DEBUG) {
                Log.d(MailChat.LOG_TAG, "No attachment info for ID: " + id);
            }
            return null;
        }
    ...
    private String getType(String dbName, String id, String format) {
        ...
        if (FORMAT_THUMBNAIL.equals(format)) {
            ...
            try {
                final LocalStore localStore = LocalStore.getLocalInstance(account, MailChat.app);
                ...
                Log.e(MailChat.LOG_TAG, "Unable to retrieve LocalStore for " + account, e);
                type = null;
            }
        }
    ...
    private File getFile(String dbName, String id) throws FileNotFoundException {
        ...
        File attachmentsDir = StorageManager.getInstance(MailChat.app).getAttachmentDirectory(dbName,
