...
public class LocalSearch implements SearchSpecification {
    ...
    public String getRemoteSearchArguments() {
        ...
        for (ConditionsTreeNode node : leafSet) {
            if (node.getCondition().field == Searchfield.SUBJECT
                    ...
                    || node.getCondition().field == Searchfield.TO) {
    ...
    public String getFolderSecName() {
		return folderSecName;
	}

	public void setFolderSecName(String folderSecName) {
		this.folderSecName = folderSecName;
	}
