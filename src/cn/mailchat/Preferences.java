...
import cn.mailchat.preferences.Editor;
...
public class Preferences {
    ...
    private Preferences(Context context) {
        ...
        mContext = context;
        if (mStorage.size() == 0) {
            Log.i(MailChat.LOG_TAG, "Preferences storage is zero-size, importing from Android-style preferences");
    ...
    public synchronized Account newAccount(String email) {
        newAccount = new Account(MailChat.app,email);
        accounts.put(newAccount.getUuid(), newAccount);
        accountsInOrder.add(newAccount);
    ...
    // Modified by LL
    // BEGIN
    public synchronized Account addAccount(Account acc) {
