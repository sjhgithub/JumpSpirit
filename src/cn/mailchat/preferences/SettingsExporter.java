...
import cn.mailchat.preferences.Settings.SettingsDescription;
...
public class SettingsExporter {
        ...
        try
        {
            ...
            if (os != null) {
                try {
                    ...
                    Log.w(MailChat.LOG_TAG, "Couldn't close exported settings file: " + filename);
                }
            }
        }
    }
    ...
    public static void exportPreferences(Context context, OutputStream os, boolean includeGlobals,
        ...
        try {
            ...
            Log.i(MailChat.LOG_TAG, "Exporting preferences");
        ...
        for (Entry<String, TreeMap<Integer, SettingsDescription>> versionedSetting :
            ...
            if (valueString != null) {
                try {
                    ...
                    Log.w(MailChat.LOG_TAG, "Global setting \"" + key  + "\" has invalid value \"" +
                            valueString + "\" in preference storage. This shouldn't happen!");
                }
            } else {
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "Couldn't find key \"" + key + "\" in preference storage." +
                            "Using default value.");
                }
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(MailChat.LOG_TAG, "Account setting \"" + keyPart  + "\" (" +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(MailChat.LOG_TAG, "Identity setting \"" + identityKey +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        Log.w(MailChat.LOG_TAG, "Folder setting \"" + folderKey +
                                "\" has invalid value \"" + valueString +
                                "\" in preference storage. This shouldn't happen!");
                    }
                }
