...
import cn.mailchat.MailChat.Theme;
import cn.mailchat.preferences.Settings.*;
...
public class GlobalSettings {
    ...
    static {
        ...
        s.put("backgroundOperations", Settings.versions(
                new V(1, new EnumSetting<MailChat.BACKGROUND_OPS>(
                        MailChat.BACKGROUND_OPS.class, MailChat.BACKGROUND_OPS.WHEN_CHECKED_AUTO_SYNC))
            ));
        ...
        s.put("theme", Settings.versions(
                new V(1, new ThemeSetting(MailChat.Theme.LIGHT))
            ));
        s.put("messageViewTheme", Settings.versions(
                new V(16, new ThemeSetting(MailChat.Theme.LIGHT)),
                new V(24, new SubThemeSetting(MailChat.Theme.USE_GLOBAL))
            ));
     ...
     *
     * <p>
     * Set <em>messageViewTheme</em> to {@link MailChat.Theme#USE_GLOBAL} if <em>messageViewTheme</em> has
    ...
    public static class SettingsUpgraderV24 implements SettingsUpgrader {
        ...
        @Override
        public Set<String> upgrade(Map<String, Object> settings) {
            MailChat.Theme messageViewTheme = (MailChat.Theme) settings.get("messageViewTheme");
            MailChat.Theme theme = (MailChat.Theme) settings.get("theme");
            if (theme != null && messageViewTheme != null && theme == messageViewTheme) {
                settings.put("messageViewTheme", MailChat.Theme.USE_GLOBAL);
            }
    ...
    public static class LanguageSetting extends PseudoEnumSetting<String> {
        ...
        public LanguageSetting() {
            ...
            String[] values = MailChat.app.getResources().getStringArray(R.array.settings_language_values);
    ...
    public static class ThemeSetting extends SettingsDescription {
        ...
        public ThemeSetting(MailChat.Theme defaultValue) {
            super(defaultValue);
        }
        ...
        public Object fromString(String value) throws InvalidSettingValueException {
            try {
                ...
                if (theme == MailChat.Theme.LIGHT.ordinal() ||
                ...
                } else if (theme == MailChat.Theme.DARK.ordinal() || theme == android.R.style.Theme) {
        ...
        public String toString(Object value) {
            return Integer.toString(((MailChat.Theme) value).ordinal());
        }
    }
    ...
    public static class SubThemeSetting extends ThemeSetting {
        ...
        public Object fromString(String value) throws InvalidSettingValueException {
            try {
                Integer theme = Integer.parseInt(value);
                if (theme == MailChat.Theme.USE_GLOBAL.ordinal()) {
        ...
        @Override
        public String toPrettyString(Object value) {
            if (((MailChat.Theme) value) == MailChat.Theme.USE_GLOBAL) {
