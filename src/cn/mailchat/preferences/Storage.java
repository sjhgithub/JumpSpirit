...
public class Storage implements SharedPreferences {
    ...
    private SQLiteDatabase openDB() {
        ...
        if (mDb.getVersion() == 1) {
            Log.i(MailChat.LOG_TAG, "Updating preferences to urlencoded username/password");
            ...
            if (accountUuids != null && accountUuids.length() != 0) {
                ...
                for (String uuid : uuids) {
                    try {
                        ...
                        Log.e(MailChat.LOG_TAG, "ooops", e);
                    }
                }
            }
        ...
        if (mDb.getVersion() != DB_VERSION) {
            Log.i(MailChat.LOG_TAG, "Creating Storage database");
    ...
    public static Storage getStorage(Context context) {
        ...
        if (tmpStorage != null) {
            if (MailChat.DEBUG) {
                Log.d(MailChat.LOG_TAG, "Returning already existing Storage");
            }
            return tmpStorage;
        } else {
            if (MailChat.DEBUG) {
                Log.d(MailChat.LOG_TAG, "Creating provisional storage");
            }
            tmpStorage = new Storage(context);
            Storage oldStorage = storages.putIfAbsent(context, tmpStorage);
            if (oldStorage != null) {
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "Another thread beat us to creating the Storage, returning that one");
                }
                return oldStorage;
            } else {
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "Returning the Storage we created");
                }
                return tmpStorage;
            }
        }
    ...
    private void loadValues() {
        ...
        Log.i(MailChat.LOG_TAG, "Loading preferences from DB into Storage");
        Cursor cursor = null;
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if (MailChat.DEBUG) {
                    Log.d(MailChat.LOG_TAG, "Loading key '" + key + "', value = '" + value + "'");
                }
            ...
            Log.i(MailChat.LOG_TAG, "Preferences load took " + (endTime - startTime) + "ms");
        }
    }
    ...
    //@Override
    public cn.mailchat.preferences.Editor edit() {
        return new cn.mailchat.preferences.Editor(this);
    }
    ...
    public float getFloat(String key, float defValue) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Could not parse float", nfe);
            return defValue;
        }
    }
    ...
    public int getInt(String key, int defValue) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Could not parse int", nfe);
            return defValue;
        }
    }
    ...
    public long getLong(String key, long defValue) {
        ...
        try {
            ...
            Log.e(MailChat.LOG_TAG, "Could not parse long", nfe);
            return defValue;
        }
    }
    ...
    private void writeValue(SQLiteDatabase mDb, String key, String value) {
        ...
        if (result == -1) {
            Log.e(MailChat.LOG_TAG, "Error writing key '" + key + "', value = '" + value + "'");
        }
    }
