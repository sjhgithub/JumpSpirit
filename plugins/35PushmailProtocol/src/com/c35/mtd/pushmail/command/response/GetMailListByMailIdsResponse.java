 ...
 * @Date:2012-11-2
 */
public class GetMailListByMailIdsResponse extends BaseResponse {

	List<C35Message> mails;
	...
	public void initFeild(String response) throws MessagingException {
		...
		// Debug.e("GetMailListByMailIdsResponse", commandMessage);
		...
		try {
			...
			throw new MessagingException(MessagingException.RETURN_COMMAND_ERROR_GETMAILLISTBYMAILIDS, e.getMessage());
		}
	}
}
