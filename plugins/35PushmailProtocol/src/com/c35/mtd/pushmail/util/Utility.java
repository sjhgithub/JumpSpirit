...
//	}
	...
	public static void setLanguage(String language){
		try {
			...
			C35AppServiceUtil.writeSubscribeInformationToSdcard("MODEL : " + e.getMessage());// 彩蛋log写入
		}
		
		Configuration config = EmailApplication.getInstance().getResources().getConfiguration(); 
	    DisplayMetrics metrics = EmailApplication.getInstance().getResources().getDisplayMetrics(); 
	    ...
	    EmailApplication.getInstance().getResources().updateConfiguration(config, metrics); 
	}
}
