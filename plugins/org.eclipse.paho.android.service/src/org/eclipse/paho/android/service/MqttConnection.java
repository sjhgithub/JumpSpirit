...
class MqttConnection implements MqttCallback {
	...
	private class MqttConnectionListener implements IMqttActionListener {
		...
		public void onSuccessByTime(IMqttToken asyncActionToken, long time) {
			// TODO Auto-generated method stub
			resultBundle.putLong("timeStamp", time);
			resultBundle.putString(MqttServiceConstants.CALLBACK_ACTION,
					MqttServiceConstants.SEND_TIME_ACTION);
			service.callbackToActivity(clientHandle, Status.OK, resultBundle);
		}
		//end
	}
	...
	synchronized void reconnect() {
		...
		if (disconnected && !cleanSession) {
			...
			try {
				...
				/**
				 * 修复重连时client 空指针问题
				 * http://www.umeng.com/apps/d2c2002d435c89dfcaabe645/error_types/56fa7f8a498e670357ee9cee
				 */
				if (myClient != null) {
